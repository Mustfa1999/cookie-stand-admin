        ...
        onSubmit={props.handleSubmit}>
            <legend className="col-span-4 text-3xl my-3">
              ...
              <div className="flex items-center justify-center my-2 w-full bg-emerald-300 mb-6">
                ...
                shadow-md" 
                type={"text"} placeholder={"Bercelona"} defaultValue="Bercelona"/>
              </div>
              ...
              <div className="grid grid-cols-4 grid-rows-2 gap-1">
                ...
                <input name="min" defaultValue="0" className="mx-2 mb-2 h-fit" type={"number"} placeholder={"2"}/>
                <input name="max" defaultValue="100" className="mx-2 mb-2 h-fit" type={"number"} placeholder={"4"}/>
                <input name="avg" defaultValue="50" className="mx-2 mb-2 h-fit" type={"text"} placeholder={"2.5"}/>
              </div>
        </form>
